...
const platforms = [
  {
    ...
    stats: [
      ...
      { label: 'Contests', value: 20, suffix: '+' },
      { label: 'Rating', value: 1727 },
      { label: 'Global Rank', value: 153585, suffix: '+' },
    ],
  ...
  },
  {
    ...
    stats: [
      { label: 'Current Rating', value: 1076 },
      { label: 'Max Rating', value: 1089 },
      { label: 'Contests', value: 8, suffix: '+' },
  ...
  },
  {
    ...
    stats: [
      ...
      { label: 'Stars', value: 2 },
      { label: 'Contests', value: 5, suffix: '+' },
      { label: 'Problems Solved', value: 30, suffix: '+' },
    ],
